...
export const RootLayout = () => {
  ...
  return (
    <RootLayoutContext.Provider value={{ dark, setDark }}>
      <div className="flex">
        <Sidebar>
          <SidebarItem
        ...
        {/* <div
        className={`relative flex-shrink-0 flex flex-col h-screen duration-500 px-4 ${
          open ? "w-[280px]" : "w-[70px]"
        } py-4 bg-[#09111d] shadow-xl float-right`}
      >
        <div
        ...
        >
          ...
          >
            <i className="fa fa-solid fa-bars text-white"></i>
          </button>
        </div>
        ...
        <div
          className={`flex flex-row duration-500 gap-5 items-center ${
            !open ? "flex-col" : "justify-between"
          }`}
        >
          <Switch
            checkedChildren={<i className="fa-solid fa-moon"></i>}
            unCheckedChildren={<i className="fa-solid fa-sun"></i>}
            defaultChecked
          />
        ...
        {/* <div className="flex flex-col flex-shrink-0  items-center w-40 h-screen overflow-hidden text-gray-400 bg-gray-900 rounded">
        ...
        <main className="m-4 duration-500 w-full relative">
